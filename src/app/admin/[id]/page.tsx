...
export default function DashboardPage() {
  ...
  <div className="space-y-4">
    ...
    {[
      { label: "Products", icon: <ShoppingCart className="w-4 h-4" /> },
      ...
      { label: "Blog", icon: <BookOpen className="w-4 h-4" /> },
      { label: "Settings", icon: <Settings className="w-4 h-4" /> },
    ].map((item) => (
      <div
        key={item.label}
        className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100 cursor-pointer transition"
      >
        {item.icon}
